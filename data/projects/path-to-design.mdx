...
[How I decreased **Bounce rate** by **11%**](/projects/case-study/path-to-design-decrease-bounce-rate)

## General Views(???)

![Master views taken from Figma](/project-path-to-design/01-slide.jpg)
![Components taken from Figma](/project-path-to-design/02-slide.jpg)
![Design system taken from Figma](/project-path-to-design/03-slide.jpg)
![Master views taken from Figma](/project-path-to-design/04-slide.jpg)
